export const products = [
    ...
    { 
        ...
        description: 'Sharper, faster, more efficient vs. all previous generations of beard trimmers, length settings in 0.5 mm step sizes for an effortless trimming experience,Lifetime Sharp Blades for even beard trimming and hair clipping',
        discount: 'From ₹499', 
